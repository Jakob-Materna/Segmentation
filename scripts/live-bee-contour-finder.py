...
if __name__ == "__main__":
    ...
    output_dir = "/mnt/c/Projects/Master/Data/Processed/2-LiveWingCrops/"
    ...
    for idx, jpg_file_path in enumerate(jpg_files, 1):
        ...
        marker_warnings_before = marker_warnings
        wing_warnings_before = wing_warnings
    ...
    print("\nTotal Warnings:")
    print(f"No Wings Identified: {wing_warnings}")
    print(f"No Markers Identified: {marker_warnings}")
